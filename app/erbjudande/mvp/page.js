...
const Mvp = () => {
    return (
        <section className="mbp-container">
            ...
            <OffersHero subtitle={data.offersHero2.subtitle}
                        title={data.offersHero2.title}
                        description={data.offersHero2.description}
                        img={data.offersHero2.img}
                        imgOverlay={data.offersHero2.imgOverlay}
                        heroCta={data.offersHero2.heroCta}
                        button={data.offersHero2.button}
            />
