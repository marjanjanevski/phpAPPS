...
const HomeHero = ({title, subtitle }) => {
    return (
        <div className="bg-white lg:-mt-[110px]">
            <div className="mbp-container relative grid grid-cols-12 items-center h-[30vh] md:h-[70vh] lg:h-[100vh]">
                ...
                <Image className="absolute bottom-0 right-0 -translate-x-1/2 w-[52px] md:w-[100px] lg:w-[200] h-[186px] md:h-[460px] lg:h-[924px]" src={"/icons/sideBannerHome.svg"} alt={"Side Banner Image Here"} width={200} height={924}/>
